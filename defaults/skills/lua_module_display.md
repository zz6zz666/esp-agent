...
## Typical setup (desktop simulator)
...
```lua
display.draw_text(16, 24, "你好 World! 😊", {
    r = 255,
    g = 215,
    b = 0,
    font_size = 24,
...
Text supports Unicode: Chinese, Japanese, emoji, and special symbols.
...
- Most APIs raise Lua errors when arguments are invalid or the HAL fails
- Numeric arguments accept both integers and floats (floats are rounded)

## Recommended usage pattern

1. Call `display.begin_frame(...)`

/*
 * builtin_font_8x16.h — 8x16 VGA bitmap font (ASCII 32-127)
 *
 * Generated from the standard PC VGA ROM font.
 * Each glyph is 16 bytes (8 pixels wide, 16 rows tall, MSB leftmost).
 */
#pragma once
